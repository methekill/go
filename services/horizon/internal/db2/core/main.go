...
// Offer is row of data from the `offers` table from fable-core
type Offer struct {
...
// Signer is a row of data from the `signers` table from fable-core
type Signer struct {
	Accountid string
	Publickey string
	Weight    int32
...
// Transaction is row of data from the `txhistory` table from fable-core
...
// TransactionFee is row of data from the `txfeehistory` table from fable-core
...
// Trustline is a row of data from the `trustlines` table from fable-core
...
// fable-core database this ingestion system is communicating with.  Horizon,
