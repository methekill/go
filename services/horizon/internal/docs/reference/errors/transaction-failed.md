...
| `result_xdr`               | String | A base64-encoded representation of the TransactionResult XDR returned by fable-core when submitting this transactions.    |
| `result_codes.transaction` | String | The transaction result code returned by fable-core.                                                                       |
