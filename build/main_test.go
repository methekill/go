...
// encodes it into a base64 string capable of being submitted to fable-core.
//
...
// encodes the transaction into a base64 string capable of being submitted to fable-core. It uses
...
// being submitted to fable-core. It uses the transaction builder system.
func ExamplePayment() {
	seed := "SDOTALIMPAM2IV65IOZA7KZL7XWZI5BODFXTRVLIHLQZQCKK57PH5F3H"
	tx, err := Transaction(
		SourceAccount{seed},
