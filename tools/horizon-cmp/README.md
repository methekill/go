...
```bash
horizon-cmp -t https://new-horizon.host.org -b https://horizon.arunika.io
```
...
```bash
horizon-cmp -t https://new-horizon.host.org -b https://horizon.arunika.io -a ./elb_access.log
```
...
```bash
horizon-cmp -t https://new-horizon.host.org -b https://horizon.arunika.io --rps 10
```
